          ...
          <div className="text-center">
            ...
            <div className="mt-4 flex flex-col items-center gap-3">
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-full transition-all duration-300 transform hover:scale-105 backdrop-blur-sm border border-white/30"
              >
