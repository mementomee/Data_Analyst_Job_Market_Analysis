...
LIMIT 5;
-- This query retrieves the top 5 most demanded skills for Data Analyst jobs, counting the number of job postings that require each skill and calculating the percentage of total Data Analyst jobs that require each skill.
/* Key Findings:
